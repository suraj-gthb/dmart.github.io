                        ...
                        <div class="row ">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                <div class="card-content">
                                    ...
                                    <h2 class="mb-3 font-18">{{$cats = App\Models\tbl_category::count()}}</h2>
                        ...
                        <div class="row ">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                <div class="card-content">
                                    ...
                                    <h2 class="mb-3 font-18">{{$cats = App\Models\tbl_product::count()}}</h2>
                        ...
                        <div class="row ">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                <div class="card-content">
                                    ...
                                    <h2 class="mb-3 font-18">{{$cats = App\Models\tbl_customer::count()}}</h2>
                        ...
                        <div class="row ">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                <div class="card-content">
                                    ...
                                    <h2 class="mb-3 font-18">{{$cats = App\Models\tbl_order::count()}}</h2>
