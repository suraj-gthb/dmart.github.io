      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="{{asset('dashboard')}}"> <img alt="image" src="{{asset('admin/img/logo.png')}}" class="header-logo" /> <span
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              <a href="{{asset('dashboard')}}" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="briefcase"></i><span>Category</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{asset('add-category')}}">Add Category</a></li>
                <li><a class="nav-link" href="{{asset('view-category')}}">View Category</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{asset('add-product')}}">Add Product</a></li>
                <li><a class="nav-link" href="{{asset('view-product')}}">View Product</a></li>
                <li><a class="nav-link" href="{{asset('inwards')}}">Inwards</a></li>
              </ul>
            </li>
            <!-- <li class="dropdown">
